...
import { checkHealth, fetchDigestStats, rebuildDigest } from "@indexion/api-client";
...
export const ConnectionGuard = (): React.JSX.Element => {
  ...
  const handleRetry = useCallback(() => { setRetrying(true); check().finally(() => setRetrying(false)); }, [check]);
