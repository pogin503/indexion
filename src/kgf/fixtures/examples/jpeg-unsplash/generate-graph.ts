/**
 * @file Generate graph.json from an Unsplash JPEG fixture using jpeg-hex.kgf.
 */
...
const exampleDir = join("src", "kgf", "__fixtures__", "examples", "jpeg-unsplash");
const imageFile = "photo-w400.jpg";
const imagePath = join(exampleDir, imageFile);
const hexPath = join(exampleDir, `${imageFile}.hex`);
