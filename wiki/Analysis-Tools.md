<!-- indexion:sources cmd/indexion/plan/, src/similarity/, src/pipeline/comparison/ -->
# Analysis Tools
...
- [[Similarity Algorithms (src/similarity)]] -- NCD, TF-IDF, APTED, TSED algorithm internals
